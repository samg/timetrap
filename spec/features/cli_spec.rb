describe 'CLI' do
  ...
  describe 'edit' do
    ...
    context 'with external editor' do
      ...
      it 'should open an editor for editing the note' do |_example|
      ...
      it 'should pass existing note to editor' do |_example|
        capture = nil
        allow(Timetrap::CLI).to receive(:system) do |editor_command|
          path = editor_command.match(/#{note_editor_command} (?<path>.*)/)
      ...
      it 'should edit a non running entry with an external editor' do |_example|
        not_running = Timetrap::Timer.active_entry
        Timetrap::Timer.stop(Timetrap::Timer.current_sheet)
        Timetrap::Timer.start 'another entry', nil
      ...
      context 'appending' do
        it 'should open an editor for editing the note with -z' do |_example|
          allow(Timetrap::CLI).to receive(:system) do |editor_command|
            path = editor_command.match(/#{note_editor_command} (?<path>.*)/)
        ...
        it 'should open a editor for editing the note with --append' do |_example|
          allow(Timetrap::CLI).to receive(:system) do |editor_command|
            path = editor_command.match(/#{note_editor_command} (?<path>.*)/)
            File.write(path[:path], 'appended in editor')
          end
    ...
    describe 'auto_sheet' do
      context 'using dotfiles auto_sheet' do
        context 'with a .timetrap-sheet in cwd' do
      ...
      context 'using YamlCwd autosheet' do
        context 'with cwd in auto_sheet_paths' do
        ...
        context 'with ancestor of cwd in auto_sheet_paths' do
          it 'should use sheet defined in config' do
            with_stubbed_config(
        ...
        context 'with cwd not in auto_sheet_paths' do
        ...
        context 'with cwd and ancestor in auto_sheet_paths' do
      ...
      context 'using nested_dotfiles auto_sheet' do
        context 'with a .timetrap-sheet in cwd' do
          it 'should use sheet defined in dotfile' do
            Dir.chdir('spec/dotfile') do
      ...
      describe 'text' do
        before do
          ...
          @desired_output_with_ids = <<~OUTPUT
            ...
            4   Fri Oct 03, 2008   12:00:00 - 14:00:00   2:00:00    entry 1
            3                      16:00:00 - 18:00:00   2:00:00    entry 2
                                                         4:00:00
            5   Sun Oct 05, 2008   16:00:00 - 18:00:00   2:00:00    entry 3
            6                      18:00:00 -            2:00:00    entry 4
                                                         4:00:00
                -----------------------------------------------------------
                Total                                    8:00:00
          OUTPUT
